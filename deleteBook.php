...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <!-- Content-->
        <h3>Delete Book</h3>
        <p><form method="post" action="" id="form1">
            ...
            ?>
            <input class="bttn" type="submit" value="Delete Book">
        ...
        <?php
            ...
            if(isset($_POST['bookID']) ){
                ...
                echo "<form class='form' action= 'deletedBook.php' method='post' id='form'>";
			    echo "<fieldset>";
			    ...
			    echo "<br><br>";
				echo "<input class='button first' type='submit' value='Delete'>";
