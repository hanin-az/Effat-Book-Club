            ...
            if($error != null)
                ...
                {	
                    if (isset($_POST['Submit']))
                    {
                        ...
                        $mysql = "UPDATE events SET   eventTitle = '".$eventTitle."', eventDesc = '".$eventDesc."', eventDate = '".$eventDate."', startTime = '".$startTime."', endTime = '".$endTime."', location = '".$location."', vps = '".$vps."' WHERE eventID = '".$currentEventID."'";
